            ...
            <div class="card-body">
                <form action="{{ route('petugas.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        @error('username')
                            <span class="error invalid-feedback" style="display: block; font-size: 12px;">{{ $message }}</span> <!-- Mengubah ukuran font menjadi 12px -->
                        @enderror
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        @error('role')
                            <br><span class="error invalid-feedback" style="display: block; font-size: 12px;">{{ $message }}</span> <!-- Mengubah ukuran font menjadi 12px -->
                        @enderror
                    </div>
