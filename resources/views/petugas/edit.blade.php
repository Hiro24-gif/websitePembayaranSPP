            ...
            <div class="card-body">
                <form action="{{ route('petugas.update', ['petuga' => $petuga->id_petugas]) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="username" class="form-control @error('username') {{ 'is-invalid' }} @enderror" value="{{ $petuga->username }}" required>
                        @error('username')
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password" class="form-control @error('password') {{ 'is-invalid' }} @enderror" value="{{ $petuga->password }}" required>
                        @error('password')
                            <span class="error invalid-feedback" style="display: inline">{{ $message }}</span>
                        @enderrorA
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_petugas" class="form-control @error('nama') {{ 'is-invalid' }} @enderror" value="{{ $petuga->nama_petugas }}" required>
                        @error('nama')
                            <span class="error invalid-feedback" style="display: inline">{{ $message }}</span>
                        @enderror
                    </div>
